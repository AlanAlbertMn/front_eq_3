...
@Component({
  selector: 'app-sup-add-contabilidad',
  templateUrl: './sup-add-contabilidad.component.html',
  styleUrls: ['./sup-add-contabilidad.component.css']
})
export class SupervisorAddContabilidadComponent implements OnInit {
  ...
  create_document(){
    ...
    this.crudService.add_document(this.document)
      .then(res => {
        ...
        this.router.navigate(['./sup_contabilidad']);
      })
      .catch(err => {
        console.log(err);
      });
