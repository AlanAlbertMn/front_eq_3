...
@Component({
  selector: 'app-sup-contabilidad',
  templateUrl: './sup-contabilidad.component.html',
  styleUrls: ['./sup-contabilidad.component.css']
})
export class SupervisorContabilidadComponent implements OnInit {
  displayedColumns: string[] = ['Nombre', 'Supervisor', 'Tipo', 'Fecha', 'estado', 'Opciones'];
